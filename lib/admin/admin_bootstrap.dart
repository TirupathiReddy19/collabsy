...
/// Mirrors `app/app_bootstrap.dart`'s deferred-init pattern — renders a
/// frame immediately instead of blocking on [Firebase.initializeApp].
/// Deliberately doesn't wire Crashlytics (no Web platform support) or
/// Analytics (not used in the admin portal, per a deliberate decision to
/// skip that integration for now).
