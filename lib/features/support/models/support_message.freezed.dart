...
mixin _$SupportMessage {
 ...
 String get id; SupportSenderRole get senderRole; String get text; String? get imageUrl;@NullableTimestampConverter() DateTime? get sentAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,senderRole,text,imageUrl,sentAt);

@override
String toString() {
  return 'SupportMessage(id: $id, senderRole: $senderRole, text: $text, imageUrl: $imageUrl, sentAt: $sentAt)';
}
...
@useResult
$Res call({
 String id, SupportSenderRole senderRole, String text, String? imageUrl,@NullableTimestampConverter() DateTime? sentAt
});
...
/// Create a copy of SupportMessage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? senderRole = null,Object? text = null,Object? imageUrl = freezed,Object? sentAt = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,senderRole: null == senderRole ? _self.senderRole : senderRole // ignore: cast_nullable_to_non_nullable
as SupportSenderRole,text: null == text ? _self.text : text // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  SupportSenderRole senderRole,  String text,  String? imageUrl, @NullableTimestampConverter()  DateTime? sentAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SupportMessage() when $default != null:
return $default(_that.id,_that.senderRole,_that.text,_that.imageUrl,_that.sentAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  SupportSenderRole senderRole,  String text,  String? imageUrl, @NullableTimestampConverter()  DateTime? sentAt)  $default,) {final _that = this;
switch (_that) {
case _SupportMessage():
return $default(_that.id,_that.senderRole,_that.text,_that.imageUrl,_that.sentAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  SupportSenderRole senderRole,  String text,  String? imageUrl, @NullableTimestampConverter()  DateTime? sentAt)?  $default,) {final _that = this;
switch (_that) {
case _SupportMessage() when $default != null:
return $default(_that.id,_that.senderRole,_that.text,_that.imageUrl,_that.sentAt);case _:
  return null;
...
class _SupportMessage implements SupportMessage {
  const _SupportMessage({required this.id, required this.senderRole, required this.text, this.imageUrl, @NullableTimestampConverter() this.sentAt});
  factory _SupportMessage.fromJson(Map<String, dynamic> json) => _$SupportMessageFromJson(json);

@override final  String id;
@override final  SupportSenderRole senderRole;
...
/// Create a copy of SupportMessage
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? senderRole = null,Object? text = null,Object? imageUrl = freezed,Object? sentAt = freezed,}) {
