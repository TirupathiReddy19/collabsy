...
exports.refreshInstagramMedia = void 0;
...
exports.refreshInstagramMedia = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        const media = await (0, instagramApiService_1.fetchMedia)(accessToken);
